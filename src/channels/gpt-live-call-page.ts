...
<style>
  :root {
    ...
    --accent: #0f9aa0; --accent-2: #45c6c0; --accent-soft: rgba(15, 154, 160, 0.12);
    --you: #d9822b; --you-soft: rgba(217, 130, 43, 0.14); --danger: #d64541; --ok: #22a35a;
    --shadow: 0 18px 50px rgba(20, 24, 40, 0.12);
  }
  @media (prefers-color-scheme: dark) {
    :root {
      --bg: #0d0f14; --card: #161920; --ink: #eceef4; --muted: #9aa2b6; --line: #262b36;
      --accent: #34c9c6; --accent-2: #7fe0d3; --accent-soft: rgba(52, 201, 198, 0.16);
      --you: #f0a95a; --you-soft: rgba(240, 169, 90, 0.16); --danger: #ff6f66; --ok: #4cd67f;
