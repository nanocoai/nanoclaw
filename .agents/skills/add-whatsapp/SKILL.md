...
- `.Codex/skills/add-whatsapp/scripts/wa-qr-browser.ts` exists (ships with this skill)
...
```bash
pnpm exec tsx .Codex/skills/add-whatsapp/scripts/wa-qr-browser.ts
```
...
```bash
pnpm exec tsx .Codex/skills/add-whatsapp/scripts/wa-qr-browser.ts --clean
```
