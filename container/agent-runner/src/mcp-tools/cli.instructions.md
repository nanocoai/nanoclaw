...
| sessions     | list, get, usage                                                                                                                          | Active sessions (read-only) — `usage` reports token/cost totals |
...
- **Checking what you have spent** — `ncl sessions usage` reports per-session token and cost totals for your group.
