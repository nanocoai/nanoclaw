// Generic provider tool-result middleware seam (Route-C hook). INERT on pristine
// core: with no registrant, applyToolResultMiddleware returns its input UNCHANGED
