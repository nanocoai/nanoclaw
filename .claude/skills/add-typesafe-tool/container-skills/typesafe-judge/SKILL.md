...
Shorthand flags build one question of each type without writing JSON (single
quotes: a backticked field reference inside double quotes is a shell command
substitution):
