...
// Base-owned test for the result/compaction event-mapping seam. Pristine core ships NO policy,
// so this proves the upstream defaults (error/success result mapping + the delivered "Context
// compacted" result) AND the override path. The TaskFlow policy (non-null error fallback +
