...
function buildVolumeMounts(
  ...
  if (isMain) {
    ...
    // .env shadowing is handled by the entrypoint via mount --bind inside the container
    // (Apple Container only supports directory mounts, not file mounts from the host).
