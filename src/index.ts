...
async function main(): Promise<void> {
  ...
  // rows. No-op on pristine core (empty registry).
  runBackfillSteps();

  // 1c. One-time filesystem cutover — idempotent, no-op after first run.
  migrateGroupsToClaudeLocal();

  // 1d. Drain registered post-DB startup hooks. No-op on pristine core. Runs after
  ...
  // 6a. Drain registered post-services startup hooks. No-op on pristine core. Runs
