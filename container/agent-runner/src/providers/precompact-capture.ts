/**
 * PreCompact capture seam — INERT on pristine core.
 *
 ...
 * into a board's memory store. This seam is the post-archive extension point: the provider
 ...
 * applies) and `applyPreCompactCapture` is a no-op, so pristine-core behaviour is identical to
