...
> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=nanoclaw)** is a full-modal, OpenAI-compatible AI inference platform — use it as a drop-in LLM backend for NanoClaw agents via `/add-opencode` with `ANTHROPIC_BASE_URL=https://api.atlascloud.ai/v1`. Access DeepSeek-V4, Kimi K2, Qwen3, GPT-5, Gemini 2.5 Pro, Claude, and 50+ more frontier models through a single API. Get started: [coding plan](https://www.atlascloud.ai/console/coding-plan).
