...
The OAuth credential is handed to the selected gateway, and the temporary native
file is removed. Iron Control stores its refresh token in a native OAuth broker
