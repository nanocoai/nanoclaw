 ...
 * Install-overlays (e.g. TaskFlow) that need a THIRD SQLite file mounted into
 ...
 * registrations it does nothing and the pristine two-DB layer is unchanged.
 *
...
export interface ExtraDbDescriptor {
  /** Stable key, e.g. 'taskflow'. Used by getExtraDb/initExtraDb/closeExtraDb. */
  name: string;
 ...
 *  singleton. Mirrors initOutboundDb/initTaskflowDb — used by subprocess
