...
function registerTelegramBotChannel(name: string, envKey: string): void {
  registerChannelAdapter(name, {
    factory: () => {
      ...
      Object.defineProperty(telegramAdapter, 'name', { value: name });
      ...
      const wrapped: ChannelAdapter = {
        ...
        async setup(hostConfig: ChannelSetup) {
          const intercepted: ChannelSetup = {
            ...hostConfig,
            onInbound: createPairingInterceptor(botUsernamePromise, hostConfig.onInbound, token, name),
          };
...
registerTelegramBotChannel('telegram', 'TELEGRAM_BOT_TOKEN');
registerTelegramBotChannel('telegram_cody', 'TELEGRAM_CODY_BOT_TOKEN');
