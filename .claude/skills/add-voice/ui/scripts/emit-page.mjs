...
// Hash of everything the page is built from, so a host test can prove the committed module
// matches the source without rebuilding. Keep this walk identical to the one in
